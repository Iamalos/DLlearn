# AUTOGENERATED! DO NOT EDIT! File to edit: GPT_dev1.ipynb.

# %% auto 0
__all__ = ['batch_size', 'block_size', 'max_iters', 'eval_interval', 'lr', 'device', 'eval_iters', 'n_embd', 'n_heads', 'n_layer',
           'dropout', 'f', 'text', 'chars', 'vocab_size', 'stoi', 'itos', 'encode', 'decode', 'data', 'n', 'train_data',
           'val_data', 'model', 'optimizer', 'context', 'get_batch', 'estimate_loss', 'Head', 'MultiHeadAttention',

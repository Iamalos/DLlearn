# AUTOGENERATED! DO NOT EDIT! File to edit: GPT_from_scratch.ipynb.

# %% auto 0
__all__ = ['batch_size', 'block_size', 'max_iters', 'eval_interval', 'lr', 'device', 'eval_iters', 'f', 'text', 'chars',
...
# %% GPT_from_scratch.ipynb 16
data = torch.tensor(encode(text), dtype=torch.long)

# %% GPT_from_scratch.ipynb 19
n = int(0.9*len(data)) # first 90% will be train, rest val
train_data = data[:n]
val_data = data[n:]

# %% GPT_from_scratch.ipynb 24
def get_batch(split):
...
# %% GPT_from_scratch.ipynb 37
optimizer = torch.optim.AdamW(model.parameters(), lr=lr)

# %% GPT_from_scratch.ipynb 39
